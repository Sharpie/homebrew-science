...
class Uemacs < Formula
  ...
  def install
    inreplace 'Makefile' do |s|
      ...
      s.change_make_var! 'LIBDIR', prefix+'etc'
  ...
  def caveats
    <<-EOS.undent
      The system-wide configuration file, emacs.rc, has been installed
      to #{etc}. uemacs will also load ~/.emrc if it exists. You can
